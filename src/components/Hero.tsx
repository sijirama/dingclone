    ...
    <main className="w-full bg-white py-7 md:py-18 z-10">
      <section className='max-w-[430px] md:max-w-[1300px] mx-auto grid md:grid-cols-2'>
          ...
          <div className='flex flex-col justify-start gap-1'>
            ...
            <h1 className='py-2 text-center md:text-left font-semibold text-5xl md:text-6xl lg:text-7xl '>Access to over 5000+ Fucks given from people all over Nigeria</h1>
            ...
            <form onSubmit={handleSubmit} className='max-w-[700px] mx-auto md:mx-0 p-4 w-2/3 md:w-2/3 shadow-lg rounded-md flex justify-between items-center '>
              <input type='text' 
                      ...
                      className='bg-white w-5/6 text-gray-500 focus:outline-none active:border-none' />
